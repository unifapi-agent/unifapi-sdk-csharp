# Unifapi.Sdk.Model.SeoBacklinksBulkPageSummaryItem

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**Url** | **string** | Page, domain, or subdomain echoed from the request. | 
**MainDomainRank** | **int** | Backlink rank of the page&#39;s root domain. | [optional] 
