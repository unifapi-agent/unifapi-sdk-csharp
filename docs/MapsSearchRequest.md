# Unifapi.Sdk.Model.MapsSearchRequest
...
**SearchThisArea** | **bool** | When true, return results from the displayed map area rather than the broader location. | [optional] 
**SearchPlaces** | **bool** | When true, use search-places mode to return listings the way the mobile app surfaces them. | [optional] 
