# Unifapi.Sdk.Model.SeoBacklinksSummaryResponse
...
**CrawledPages** | **int** | Number of target pages DataForSEO has crawled. | [optional] 
**InternalLinksCount** | **int** | Number of internal links found across the crawled target pages. | [optional] 
**ExternalLinksCount** | **int** | Number of external links found across the crawled target pages. | [optional] 
