# Unifapi.Sdk.Model.SeoPageIntersectionItem
...
**PageRankings** | [**List&lt;SeoSerpElement&gt;**](SeoSerpElement.md) | Ranking position of each requested page for the keyword, in request order. | [optional] 
