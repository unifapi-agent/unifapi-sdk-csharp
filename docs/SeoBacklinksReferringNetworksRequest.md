# Unifapi.Sdk.Model.SeoBacklinksReferringNetworksRequest
...
**NetworkAddressType** | **string** | Group referring networks by individual IP (ip, default) or by subnet (subnet). | [optional] 
